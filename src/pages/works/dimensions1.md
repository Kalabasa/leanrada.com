...
Using only one basic shape was to create unity across the whole piece and mitigate chaos from the randomness of the algorithm.
...
<span>![](../img/dimensions_1tiles.jpg)
  <span class="caption">Random tiles added with placeholder colors. Truncated to a square for brevity.</span>
</span>
...
The QR code would link the physical and the virtual components, making it a seamless single experience.
