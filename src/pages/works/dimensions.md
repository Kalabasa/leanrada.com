...
I used the simpler kind of generative art, revolving around [**tessellations**](https://en.wikipedia.org/wiki/Tessellation) or tilings.
...
I felt like that was enough doodling around. It was time to code!
...
You may start seeing some semicircles and larger contours forming across tiles. This might help you better see what I mean:
...
See those other shapes *emerging* from the five basic tiles? If you squint hard enough, you might be able to see Pacman, maybe an apple logo, or maybe a bird.

*Emergence* is a common feature of generative art. It’s the idea that something more arises from simple systems - intentional or coincidental.
...
Random noise textures were added as well. The textures were generated solely using [GIMP](https://www.gimp.org/)’s noise generators and filters. <small>Could’ve implemented a live texture generator into the renderer, but time was limited.</small>
...
Now this has contrasting regions. Should improve composition. Points of interest also emerged from the intersections between edges. It also broke the monotony of the grid.
...
As you can see, generative art is experimental, explorative, and iterative. It’s fun!
...
*\[Live demo of the generator should be put up when I get some time to clean it up]*
