customElements.define(
  ...
  class CSSRainMachineDemo extends HTMLElement {
    constructor() {
      super();

      const demoNumber = this.getAttribute("demo-number");

      this.innerHTML = html` <div
        class="css-rain-machine-demo css-rain-machine-demo-${demoNumber}"
        data-rss="interactive"
        alt="demo of CSS-only machine"
      >
        <input
          class="css-rain-machine-rainy"
          id="css-rain-machine-rainy--${demoNumber}"
          type="checkbox"
        />
        <input
          class="css-rain-machine-sunny"
          id="css-rain-machine-sunny--${demoNumber}"
          type="checkbox"
        />
        <input
          class="css-rain-machine-windy"
          id="css-rain-machine-windy--${demoNumber}"
          type="checkbox"
        />
        ...
        <div class="css-rain-machine-box">
          <div class="css-rain-machine-screen">
            <img
              class="css-rain-machine-umbrella"
              alt="Take umbrella"
              src="./umbrella.png"
            />
            <img
              class="css-rain-machine-raincoat"
              alt="Take raincoat"
              src="./raincoat.png"
            />
          </div>
          <div class="css-rain-machine-controls">
            <label
              class="css-rain-machine-rainy"
              for="css-rain-machine-rainy--${demoNumber}"
              >Rainy</label
            >
            <label
              class="css-rain-machine-sunny"
              for="css-rain-machine-sunny--${demoNumber}"
              >Sunny</label
            >
            <label
              class="css-rain-machine-windy"
              for="css-rain-machine-windy--${demoNumber}"
              >Windy</label
            >
          </div>
        </div>
