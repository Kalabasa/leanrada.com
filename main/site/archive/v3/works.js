(function () {
	...
	function getPageName() {
		...
		return pathname.substring(12); // remove front slash
	}
	...
	var currentFilterType = undefined;
	/** @type {HTMLElement} */
	var grid = void 0;
	/** @type {HTMLElement[]} */
	var projectItemElements = void 0;

	page.ready(function () {

		grid = document.querySelector('section.works .grid');
		projectItemElements = [].concat(toConsumableArray(document.querySelectorAll('.projects-item')));

		var section = document.querySelector('section.works');
		section.addEventListener('click', function (event) {
			var item = projectItemElements.find(function (it) {
		...
		var filterToggle = document.querySelector('#filter-checkbox');
	...
	function applyFilter(type) {
		...
		try {
			for (var _iterator = projectItemElements[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
		...
		setTimeout(function () {
			...
			try {
				for (var _iterator2 = projectItemElements[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
					var _element = _step2.value;

					var visible = type === undefined || type === _element.dataset.projectType;
					if (visible) {
						_element.classList.remove('projects-item-hiding');
						_element.classList.remove('projects-item-hidden');
					} else {
						_element.classList.add('projects-item-hidden');
					}
				}
			} catch (err) {
				_didIteratorError2 = true;
