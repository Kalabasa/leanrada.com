(function () {
	...
	page.ready(function () {
		...
		var introSection = [].concat(toConsumableArray(document.querySelectorAll('.intro'))).pop();
		introSection.addEventListener('click', function (event) {
			console.log(event.target);
			if (event.target instanceof HTMLAnchorElement && event.target.classList.contains('intro-anchor-link') && event.target.hash) {
